...
export function isStaffIdLabel(label) {
...
export function ensureStaffVerificationFields(fields) {
  if (!Array.isArray(fields)) return createStaffVerificationFields();
...
export function getStaffIdFromAnswers(fields, answers) {
